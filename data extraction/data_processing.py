...
# Das folgende Skript lädt die zuvor heruntergeladenen Rohdaten, bearbeitet sie, joint alle Daten 
# in eine finale Tabelle und export diese als 'COVID-19-time-series-clean-complete.csv' in den Ordner
...
# Anmerkung: Probleme mit Zahlen von Kanada -> nicht nach Provinz, sondern nach Country gezaehlt
